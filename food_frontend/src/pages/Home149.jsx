  ...
  return (
    <div className="screen">
      ...
      <div className="profile-container">
        <img src="/assets/figmaimages/figma_image_1_54.png" alt="Profile" />
      </div>

      <div className="search-container">
        <div className="search-group">
          <img src="/assets/figmaimages/figma_image_1_61.svg" alt="Search" className="search-icon" />
          <span className="typo-7">Search</span>
        </div>
      </div>

      <button className="filter-button">
        <img src="/assets/figmaimages/figma_image_1_59.svg" alt="Filter" />
      </button>
        ...
        {foodItems.map(item => (
          <div key={item.id} className="food-card">
            ...
            <div className="rating-container">
              <img src="/assets/figmaimages/figma_image_1_85.svg" alt="Star" className="star-icon" />
            ...
            <button className="heart-button" onClick={() => toggleLike(item.id)}>
              <img 
                src={likedItems.has(item.id) 
                  ? "/assets/figmaimages/figma_image_1_122.svg" 
                  : "/assets/figmaimages/figma_image_1_80.svg"} 
                alt="Heart" 
              />
            </button>
          </div>
      ...
      <div className="bottom-nav">
        <div className="nav-icons">
          <img src="/assets/figmaimages/figma_image_1_123.svg" alt="Home" className="nav-icon" />
          <img src="/assets/figmaimages/figma_image_1_124.svg" alt="User" className="nav-icon" />
          <img src="/assets/figmaimages/figma_image_1_125.svg" alt="Comment" className="nav-icon" />
          <img src="/assets/figmaimages/figma_image_1_80.svg" alt="Heart" className="nav-icon" />
        </div>
